...
[![CI](https://github.com/jtlyu/what-is-on-my-disk/actions/workflows/ci.yml/badge.svg)](https://github.com/jtlyu/what-is-on-my-disk/actions/workflows/ci.yml)
[![Release](https://github.com/jtlyu/what-is-on-my-disk/actions/workflows/release.yml/badge.svg)](https://github.com/jtlyu/what-is-on-my-disk/actions/workflows/release.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-ff6fa8.svg)](LICENSE)
[![Downloads](https://img.shields.io/github/downloads/jtlyu/what-is-on-my-disk/total?color=ff6fa8)](https://github.com/jtlyu/what-is-on-my-disk/releases)

[**📥 下载 Windows 安装包**](https://github.com/jtlyu/what-is-on-my-disk/releases/latest) ·
[macOS](https://github.com/jtlyu/what-is-on-my-disk/releases/latest) ·
[Linux](https://github.com/jtlyu/what-is-on-my-disk/releases/latest) ·
[贡献清理脚本](docs/SCAFFOLD-AUTHORING.md) ·
[问题反馈](https://github.com/jtlyu/what-is-on-my-disk/issues)
...
1. 打开 **[Releases 页面](https://github.com/jtlyu/what-is-on-my-disk/releases/latest)**。
...
```bash
git clone https://github.com/jtlyu/what-is-on-my-disk && cd diskwise
pnpm install
...
**没找到你想清的 App？** [开个 Issue](https://github.com/jtlyu/what-is-on-my-disk/issues/new?template=scaffold-request.yml)，或者照 [docs/SCAFFOLD-AUTHORING.md](docs/SCAFFOLD-AUTHORING.md) 自己写一个 `.toml` 提 PR。
